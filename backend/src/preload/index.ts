...
function buildRuntime(): Record<string, unknown> {
  ...
  const base: Record<string, unknown> = {
    ...
    /** 主进程仅在此之后拦截关窗；避免白屏时关不掉 */
    NotifyCloseGuardReady: () => ipcRenderer.send('renderer:close-guard-ready'),
...
const appMethodNames = [
  ...
  'BrowserProfileCredentialDelete',
  'BrowserProfileCredentialList',
  'BrowserProfileCredentialSave',
  'BrowserProfileCopy',
